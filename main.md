...
- `AUDIO JP CHE` Long-haired girl (bilingual EN/ZH + audio)
- `JP CRE` Freight train = Tren de carga
- `JP MYF` Bao bao biao qing ji: My Face Book (baby faces)

## Not on the shelf right now (out or in-library only)

Bluey : zoo., Chugga-chugga choo-choo, Grumpy monkey yuck!, In my heart : a book of feelings, Tap the magic tree, Ten little fingers and ten little toes, The color monster : a story about emotions, The pigeon needs a bath!, The very quiet cricket, The watermelon seed
