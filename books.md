...
## 🏆 Lakeview Branch — 1137 W. Lake Ave. — 21 titles on shelf

*Open today (Sun) Noon–5 PM; Mon–Wed 10–8; Fri–Sat 10–6; **closed Thursdays**. Phone 309-497-2200.*

All call numbers are in the Juvenile section: **Board Book** shelves (BB) or **Picture Book** shelves (PB).

### Feelings (his favorites!)
- [ ] **In My Heart: A Book of Feelings** — Jo Witek — `JP WIT` (PB) ← *the only copy available in the whole system is here*
- [ ] **The Color Monster: A Story About Emotions** — Anna Llenas — `JP LLE` (PB)
- [ ] **Grumpy Monkey** (the original) — Suzanne Lang — `JP LAN` (PB)
- [ ] **Grumpy Monkey Yuck!** — Suzanne Lang — `JP LAN` (BB)
- [ ] **Grumpy Monkey Party Time!** — Suzanne Lang — `JP LAN` (PB)
- [ ] **Grumpy Monkey: Mom for a Day** — Suzanne Lang — `JP LAN` (PB)

### Trucks & vehicles
- [ ] **Goodnight, Goodnight, Construction Site** — Sherri Duskey Rinker — `JP RIN` (PB)
- [ ] **Duck Stays in the Truck** — Doreen Cronin — `JP CRO` (Reader shelf; 2 copies)
- [ ] **Mike Delivers: The Duck Is Stuck!** — Dana Regan — `JP REG` (Reader shelf)

### Animals
- [ ] **Brown Bear, Brown Bear, What Do You See?** — Martin/Carle — `JP MAR` (BB)
- [ ] **Polar Bear, Polar Bear, What Do You Hear?** — Martin/Carle — `JP MAR` (BB)
- [ ] **Moo, Baa, La La La!** — Sandra Boynton — `JP BOY` (BB)
- [ ] **Moo, Baa, Fa La La La La!** — Sandra Boynton — `JP BOY` (BB)

### Interactive
- [ ] **Where's Spot?** — Eric Hill — `JP HIL` (BB, lift-the-flap; 2 copies)
- [ ] **Higher! Higher!** — Leslie Patricelli — `JP PAT` (PB)
- [ ] **Dot! Scribble! Go!** — Hervé Tullet — `JP TUL` (PB)

### Classics & bedtime
- [ ] **Goodnight Moon** — Margaret Wise Brown — `JP BRO` (PB; 2 copies)
- [ ] **The Very Hungry Caterpillar** — Eric Carle — `JP CAR` (BB)
- [ ] **Llama Llama Red Pajama** — Anna Dewdney — `JP DEW` (PB)
- [ ] **Dragons Love Tacos** — Adam Rubin — `JP RUB` (PB, great for 3+)
- [ ] **Chicka Chicka I Love You** — Martin/Sampson — `JP MAR` (Holiday Collection shelf)

## 🏠 North Branch — 3001 W. Grand Pkwy. — closest to you, 13 titles on shelf

*Open today (Sun) Noon–5 PM; Mon/Wed/Thu 10–8; Fri–Sat 10–6; **closed Tuesdays**. Phone 309-497-2100. ~5 min from W Ivyleaf Ct.*

Titles **only** here (not on shelf at Lakeview):
- [ ] **Press Here** — Hervé Tullet — `JP TUL` (BB) — interactive magic
- [ ] **Chicka Chicka Boom Boom** — Martin/Archambault — `JP MAR` (BB)

Also on shelf here (duplicates of Lakeview picks, if North is your only stop):
Moo, Baa, La La La! (×2) · Moo, Baa, Fa La La La La! · Polar Bear, Polar Bear · Where's Spot? · Grumpy Monkey · Grumpy Monkey Yuck! · Grumpy Monkey: Mom for a Day · Dot! Scribble! Go! · Chicka Chicka I Love You · Duck Stays in the Truck · Mike Delivers: The Duck Is Stuck!

*Checked out at North (get at Lakeview instead): Brown Bear, Goodnight Moon, Llama Llama Red Pajama, In My Heart, Color Monster, Grumpy Monkey Party Time!, Time for Bed.*

## 🎈 More for 3-year-olds — added on request

Story-driven picture books he can grow into (all confirmed on shelf, same day):

### At Lakeview
- [ ] **Don't Let the Pigeon Drive the Bus!** — Mo Willems — `JP WIL` (PB; 2 copies of the 2023 edition)
- [ ] **Where the Wild Things Are** — Maurice Sendak — `JP SEN` (PB)
...
- [ ] **Where Do Diggers Sleep at Night?** — Brianna Caplan Sayres — `JP SAY` (BB; trucks + bedtime in one)
- [ ] **Don't Let the Pigeon Drive the Bus!** — Mo Willems — `JP WIL` (PB; 1 copy in, 3 out — grab it if you see it)
- [ ] **If You Give a Mouse a Cookie** — `JP NUM` (PB)
- [ ] **The Watermelon Seed** — `JP PIZ` (PB)
...
- **Dear Zoo** — Rod Campbell — Main St, `JP CAM` (PB), on shelf
